        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border bg-muted/40">
              ...
              <th className="w-44 px-4 py-2.5 text-left text-xs font-semibold uppercase tracking-wide text-muted-foreground">NCC</th>
              ...
              <th className="w-36 px-4 py-2.5 text-left text-xs font-semibold uppercase tracking-wide text-muted-foreground">Người tạo</th>
            ...
            {hook.isFetching && rows.length === 0 ? (
              ...
              rows.map((row, i) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 text-foreground">{row.deal_title ?? '—'}</td>
                  <td className="px-4 py-3 text-right font-mono text-sm text-foreground">
                    {row.total_amount ? Math.round(row.total_amount).toLocaleString('en-US') : '—'}
                  </td>
                  <td className="px-4 py-3"><StatusBadge status={row.status} /></td>
                  <td className="px-4 py-3 text-foreground">{row.created_by_name ?? '—'}</td>
