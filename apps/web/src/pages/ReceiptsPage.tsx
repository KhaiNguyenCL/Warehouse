  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight">Phiếu nhập kho</h1>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border bg-muted/40">
              ...
              <th className="w-32 px-4 py-2.5 text-left text-xs font-semibold uppercase tracking-wide text-muted-foreground">Loại nhập</th>
              <th className="px-4 py-2.5 text-left text-xs font-semibold uppercase tracking-wide text-muted-foreground">NCC</th>
              <th className="w-36 px-4 py-2.5 text-left text-xs font-semibold uppercase tracking-wide text-muted-foreground">Kho</th>
            ...
            {hook.isFetching && rows.length === 0 ? (
              ...
              rows.map((row, i) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 text-foreground">{row.import_type ?? '—'}</td>
                  <td className="px-4 py-3 font-medium text-foreground">{row.company_name ?? '—'}</td>
                  <td className="px-4 py-3 text-foreground">{row.warehouse_name ?? '—'}</td>
