        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border bg-muted/40">
              ...
              <th className="w-32 px-4 py-2.5 text-left text-xs font-semibold uppercase tracking-wide text-muted-foreground">Loại xuất</th>
              <th className="px-4 py-2.5 text-left text-xs font-semibold uppercase tracking-wide text-muted-foreground">Khách hàng / NCC</th>
            ...
            {hook.isFetching && rows.length === 0 ? (
              ...
              rows.map((row, i) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 text-foreground">{row.export_type ?? '—'}</td>
